...
const getBounds = (n, includeLabels) => n.boundingBox({ includeOverlays: false, includeLabels: includeLabels });
const getBoundsTuple = (n, includeLabels) => ({ node: n, bb: copyBounds(getBounds(n, includeLabels)) });
const copyBounds = bb => ({ x1: bb.x1, x2: bb.x2, y1: bb.y1, y2: bb.y2, w: bb.w, h: bb.h });
const getBoundsCopy = (n, includeLabels) => copyBounds(getBounds(n, includeLabels));
